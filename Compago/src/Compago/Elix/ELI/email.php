...
class ELI_email  
{
    ...
    public static function split_message($str = null) {
    ...
    public static function is_alpha($str = null, $num = true, $add = '') {
    ...
    public static function decode_content($str = null, $encoding = null ) {
        $err = array();
    ...
    public static function str_clear($str = null, $addrep = null) {
		$err = array();
		$rep = array("\r", "\n", "\t");
