 ...
 *  implement all public functions of the instance class on a STATIC basis that works on the current $_SERVER cache controll value
 * 
 * INSTANCE
...
class ELI_cachecontrol
{
    ...
    public static function get($type='CACHECONTROL') {
