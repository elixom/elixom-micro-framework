...
class ELI_random
{
    ...
    public static function sentence($words =6, $max_letter_length=0) {
        $a = array();
    ...
    public static function paragraph($length=5,$max_letter_length=0) {
        $a = array();
    ...
    static $live = false;
    static $buffer = array();
    public static function useLive($state) {
