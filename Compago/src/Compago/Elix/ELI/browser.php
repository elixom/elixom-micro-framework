...
{
    static $UA = '';
    public static function matchVersion($item='chrome',$version=0,$operator='>='){
    ...
    public static function isMobile($version=0){
        if(empty(self::$UA) && isset($_SERVER['HTTP_USER_AGENT'])) self::$UA = $_SERVER['HTTP_USER_AGENT'];
    ...
    public static function isOpera($version=0)
    {
    ...
    public static function isNetscape($version=0)
    {
    ...
    public static function isMozilla($version=0)
    {
    ...
    public static function isCHROME($version=0){
        return self::isWebkit($version);
    }
    public static function isWebkit($version=0)
    {
        //This is either Chrome or Safari
        if(empty(self::$UA) && isset($_SERVER['HTTP_USER_AGENT'])) self::$UA = $_SERVER['HTTP_USER_AGENT'];
    ...
    public static function isRobot($filename)
    {
    ...
    */
     ...
     * @return
     */
    public static function isMSIE($version=0)
    {
        if(empty(self::$UA) && isset($_SERVER['HTTP_USER_AGENT'])) self::$UA = $_SERVER['HTTP_USER_AGENT'];
