...
class ELI
{
    ...
    public static function debug_backtrace(){
        ...
        //array_shift($trace);// removes call to this public function
    ...
    public static function systemLoad($interval = 1){
        $rs = sys_getloadavg();
    ...
    /*private*/ public static function numCpuCores()
    {
        static $numCpus;
    ...
    public static function processCount() {
      ...
      // Only call clearstatcache() if public function called more than once */
