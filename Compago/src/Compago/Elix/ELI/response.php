...
class ELI_response extends \Campago\Http\Response 
{
    ...
    public function getOption($property,$default=null){
    ...
    public function setOption($property,$content='')
    {
        $p = strtolower($property);
        if($content ===null){
    ...
    public function setFile($filepath,$filename='',$type=null)
    {
        $this->debug[] = "setFile($filepath)";
        if(func_num_args()>2){
            $this->setDownload($filepath,$filename,$type);
        } elseif(func_num_args()>1){
            $this->setDownload($filepath,$filename);
        } else{
            $this->setDownload($filepath);
        }
        return $this;
    }
    public function setDownload($filepath,$filename='',$type=null)
    {
        $this->body = null;
        $this->filebody = null;
    ...
    public function setDownloadData($filedata,$filename='',$type=null)
    {
        $this->body = null;
    ...
    public function addField($field,$content){
        $this->_mk_body_array();
        if($field){
    ...
    public function setSubField($field,$subIndex,$content=null){
        $this->_mk_body_array();
    ...
    public function getField($field,$subIndex=null){
    ...
    public function CSP($value=null){
    ...
    public function CSP_Report($value=null){
    ...
    public function getHeader($property){
        $p = strtolower($property);
        if($p=='server'){
            return $this->server;
        }
    ...
    public function setHeader($property,$content='',$replace=true)
    {
        if(func_num_args()==1){
    ...
    public function setSendType($type = CONTENT_TYPE_PLAIN){
        $this->sendType = $type;
        return $this;
    }
                        ...
                        if(is_scalar($body)){
                            ...
                            if($this->getSendType()=='STRING'){
                                ...
                                if(!function_exists('implode_r')){
                                    public function implode_r ($pieces){ 
                                         $out = ""; 
    ...
    /*VERSION 2 function*/
    public function setStatusOk($message=''){
        return $this->setStatus(200,$message);
    }
    public function setStatusCreated($message='Created'){
    ...
    */
    public function setStatusAccepted($message=''){
        return $this->setStatus(202,$message);
    }
    public function setStatusNoContent($message='No Content'){
    ...
    */
    public function setStatusMoved($location,$message='', $type = 301){
    ...
    Expires, Cache-Control and Vary are required if they’ve changed since last sent.
    */
    public function setStatusNotModified($message='Not Modified'){
    ...
    public function setStatusUnauthorized($message='Unauthorized'){
    ...
    */
    public function setStatusNotFound($message='Not Found'){
    ...
    */
    public function setStatusConflict($message='Conflict'){
    ...
    */
    public function setStatusFailed($message='Precondition failed'){
...
contain more info on the problem
    */
    public function setStatusBadRequest($message='Bad Request'){
...
429 Too Many Requests - When a request is rejected due to rate limiting
    */
    public function setStatusError($type=410, $message='Gone'){
