...
class ELI_cache
{
    ...
    public function SetCacheControl($param,$value=true)
    {
    ...
    public function UnsetCacheControl($param)
    {
        unset($this->c[$param]);
    }
    ...
    public function AddEntityProperty($value)
    {
        if(func_num_args()>0)
            $value = func_get_args();
        if(is_array($value)){
    ...
    public function SetModified($date='now')
    {
        if((null ===$date))
        {
            $this->last_modified = '';
    ...
    public function SetExpires($date='now')
    {
        if((null ===$date))
        {
            $this->expires = '';
    ...
    public function checkIfModified()
    {
    ...
    private  public function _MatchModified()
    {
