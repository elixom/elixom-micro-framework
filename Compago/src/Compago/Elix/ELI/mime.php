...
class ELI_MIME
{
    ...
    public static function getMimeShell($filename){
        return trim ( exec ('file -bi ' . escapeshellarg ( $filename ) ) ) ;
    }
    public static function getMimeLive($filename){
    ...
    public static function generateUpToDateMimeArray($url=''){
    ...
    public static function getCommonMimeType($filename){
        //by extension
    ...
    public static function getExtendedMimeType($filename){
        $mime_types = array(	
