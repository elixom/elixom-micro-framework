...
class Image
{
    ...
    public function save($filename,$compression=90, $image_type=null,  $permissions=null) {
   ...
   public function toString($quality=0,$image_type=null ){
        ob_start();
   ...
   public function output($quality=0,$image_type=null ) 
   {
        if((null ===$image_type)) $image_type=$this->image_type;
    ...
    public function scaleXY($scaleX,$scaleY) {
        if(is_float($scaleX)){
    ...
    public function cropToSize($x,$y,$width,$height)
    {
        $height = (int)$height;
        $width = (int)$width;
        if($width < 0){
    ...
    public function stampImage($stamp, $x=0,$y=0,$width=0,$height=0, $opacity=50){
        if($x<0){
