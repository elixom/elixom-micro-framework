...
class SESSION
{
    ...
    protected  public function applyfilter($data){
    ...
    protected  public function change_case($value){
    ...
    /**
     * Access a request parameter as int, increate it by $tep, store it and return the new value
     * Exiting parameters will be forced to integer
     *
     * @param string    $name     Parameter name
     ...
     *
     * @param string    $name     Parameter name
     * @param int       $step     value to deacrease by
     * @return int
     */
...
class SESSION_SECURITY{
    public static function regenerate_id($delete_old=true){
        @session_write_close();
    ...
    public static function setExpire($minutes=180){
        $minutes = (int)$minutes;
        session_cache_expire($minutes);
        return $this;
    }
    public static function setPrivate($private='private'){
        if(is_bool($private)) $private = $private?'private':'public';
        @session_cache_limiter($private);
        return $this;
    }
    //nocache, private, private_no_expire, or public
    public static function setLimiter($limiter='private'){
    ...
    /*public static function setCookie($key='ELIX_SESS'){
