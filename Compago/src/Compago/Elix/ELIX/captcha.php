...
class captcha_base
{
    ...
    public function length() { return  strlen($this->answer() ); }
    public function maxlength() { return  strlen($this->answer() ) + 2 ; }
    public function q() { return $this->html; }
...
{
    public function type() { return 'quiz'; }
    public function generate(){
        $r1 = rand(1,9);
        $this->data['input'] = 'number';
        if($r1 == 2){
