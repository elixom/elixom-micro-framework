...
class RESPONSE_new {
    ...
    */
    public function setMoved($location,$message='', $type = 301){
    ...
    public function setAutoError($bool=true)
    {
        $this->autoError = $bool;
        return $this;
    }
    ...
    public function setDownload($filepath,$filename='')
    {
        if(!$filename && $filepath) $filename = basename($filepath);
        $this->body = new RESPONSE_body_file($filepath);
    ...
    public function setDownloadData($filedata,$filename='')
    {
...
class RESPONSE_helper{
    ...
    public static function getStatusClass($status=null)
    {
        if(func_num_args()){
    ...
    public static function getErrorBody($code,$type){
...
429 Too Many Requests - When a request is rejected due to rate limiting
    ...
    */
    ...
    307 Temporary Redirect
    */
    public function setStatusMoved($message='', $type = 301){
        if(!in_array($type,array(301,302,303,307))) $type =301;
        $this->setStatus($type,$message);
        return $this;
    }
...
class RESPONSE_header implements \ArrayAccess, \IteratorAggregate, \Countable{
    ...
    */
    ...
    public function CORS($value=null){
    ...
    public function CORS_ALLOW_ALL(){
        ...
        if(empty($this->etag)){
            if($this->download){
                ...
                elseif(file_exists($this->download))
                    $this->etag = md5_file($this->download);
