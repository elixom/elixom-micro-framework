...
class REQUEST{
    ...
    public static function isSoftRefresh(){
        static $r = null;
        if($r===null)
        {
    ...
    public static function isHardRefresh(){
        static $r = null;
        if($r===null)
        {
    ...
    public static function is_SOAP()
    {
        static $r = null;
        if($r===null)
        {
    ...
    public static function getByMethod()
    {
...
class REQUEST_trait{
    ...
    public function getFiltered(array $definition){
        //http://php.net/manual/en/public function.filter-var-array.php
        $a =$this->toArray();
...
class REQUEST_files extends REQUEST_trait implements \ArrayAccess, \Iterator, \Countable
{
    ...
    public function exists($name,$index=null){
...
class REQUEST_path extends REQUEST_trait implements \ArrayAccess, \Iterator, \Countable
{
    ...
    public function sub($name, $default=false) {
...
class REQUEST_request extends REQUEST_base{
    ...
    protected final public function getHelper(array $source, $name = null, $defaultValue = null, $filters = null, $notAllowEmpty = false, $noRecursive = false)
	{
		$value = null;
...
public function parse_query_string($url, $qmark=true)
{
    if ($qmark) {
        $pos = strpos($url, "?");
        if ($pos !== false) {
    ...
    * @desc
    */
public function string_pair(&$a, $delim='=', $default=false)
    {
        $n = strpos($a, $delim);
    ...
    */
    public function parse_query_string_array(&$result, $k, $arrayKeys, $value)
    {
